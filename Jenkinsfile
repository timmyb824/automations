      ...
      steps {
        ...
        script {
          try {
            ...
            slackSend channel: '#repos', color: 'good', message: ":white_check_mark: *${currentBuild.currentResult}:* Job ${env.JOB_NAME} build ${env.BUILD_NUMBER} (Terraform/Cloudflare deployment) \n More info at: ${env.BUILD_URL}"
          } catch (Exception e) {
